...
import static com.kelan.core.constant.WebConstants.POST;
import static com.kelan.core.constant.WebConstants.UTF8;
...
public class RequestUtils {
	...
	public static String getRequestedSessionId(HttpServletRequest request) {
		...
		if (request.isRequestedSessionIdFromURL() || StringUtils.isBlank(ctx)) {
			...
			// 手动从cookie获取
			Cookie cookie = CookieUtils.getCookie(request, WebConstants.SESSION_COOKIE);
			if (cookie != null) {
